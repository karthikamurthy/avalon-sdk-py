...
from utility.conversion import convert_byte32_arr_to_hex_arr
...
class EthereumWorkerRegistryImpl(WorkerRegistry):
    ...
    def worker_lookup(self, worker_type, org_id, application_id, id=None):
        ...
        self.validation.not_valid_contract(
            worker_registry_contract_instance = self.__contract_instance)
        ...
        params = {
            ...
            "applicationTypeId" : application_id
            }
        
        json_validation(id,"WorkerLookUp", params)
    ...
    def worker_retrieve(self, worker_id, id=None):
        ...
        json_validation(id,"WorkerRetrieve", params)
    ...
    def worker_lookup_next(self, worker_type, org_id, application_id,
        ...
        json_validation(None,"WorkerLookUpNext", "params")
    ...
    def worker_register(self, worker_id, worker_type, organization_id,
        ...
        json_validation(None,"WorkerRegister", params)
    ...
    def worker_update(self, worker_id, details):
        ...
        json_validation(None,"WorkerUpdate", params)
    ...
    def worker_set_status(self, worker_id, status):
        ...
        e_value = self.validation.enum_value(None, "WorkerStatus", status)
        params = {
                "workerId": worker_id,
                "status": e_value
            }

        json_validation(None,"WorkerSetStatus", params)
    ...
    def __initialize(self, config):
        ...
        self.validation.not_valid_contract( 
            worker_registry_contract_file = config.get("worker_registry_contract_file") ,
            worker_registry_contract_address = config.get("worker_registry_contract_address"))
        
        self.__eth_client = EthereumWrapper(config)
        contract_file_name = config.get("worker_registry_contract_file")
        contract_address = config.get("worker_registry_contract_address")
