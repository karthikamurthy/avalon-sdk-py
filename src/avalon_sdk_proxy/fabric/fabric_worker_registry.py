...
from avalon_sdk_fabric.fabric_wrapper \
...
class FabricWorkerRegistryImpl(WorkerRegistry):
    ...
    def __initialize(self, config):
        ...
        Parameters:
        config    fabric-specific configuration parameters to initialize
        """
        self.validation.not_null(None, config)
        self.__fabric_wrapper = FabricWrapper(config)
        self.validation.not_valid_contract(
            fabric_wrapper = self.__fabric_wrapper)
